      ...
      <div className="edit-type-page">
        <div className="mailings-push-container">
          ...
          <p className="mailings-push-description">
            Эти сообщения появятся на экране блокировки и в разделе «Последние обновления» на
            электронной карточке ваших клиентов.
          </p>
          ...
          <div className="mailings-push-box">
            ...
            <textarea className="push-textarea" placeholder="Введите текст push-уведомления" />
