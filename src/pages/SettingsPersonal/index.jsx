  ...
  return (
    <div className="settings-wrapper">
      ...
      <div className="delete-section">
        ...
        <p>
          Принесите извинения за то, что вы уходите. Прежде чем вы удалите свою учетную запись...
        </p>
        ...
        <div className="checkbox-group">
          <label>
            ...
            />{' '}
            Не получилось разобраться в сервисе
          </label>
          <label>
            <input
              type="checkbox"
        ...
        <div className="confirmation">
          <h4>Подтверждение</h4>
          <p>
            Пожалуйста, введите свой пароль администратора, чтобы удалить учетную запись с сервиса
          </p>
          <input type="password" placeholder="Пароль" />
          <p className="note">
            Как только вы удалите свою учетную запись, вся ваша личная информация и данные клиента
            будут потеряны
          </p>
        </div>
